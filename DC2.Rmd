...
# Note: Unfortunately the ID strings are not commuatative and I didn't have time to try and figure it out so 100025, 1010003 and 1010003, 100025 are listed separately; also didn't have time to try and link subsets of groups

View(n_occur_and_group_size)
```

```{r}
# Communications around time when crime is thought to have occured
